      ...
      >
        <div className="space-y-6">
          {!showTwoFactor ? (
            ...
            <>
              <div className="space-y-2">
                <label className="text-[16px] xl:text-[18px] font-medium text-[#4B5563] tracking-[-0.18px]">Two-Factor Verification Code</label>
                <input
                  {...form.register("code")}
                  disabled={isPending}
                  type="text"
                  ...
                  className="w-full text-center tracking-widest text-[20px] font-black h-[56px] xl:h-[64px] px-4 rounded-[16px] border border-[#E3E8F4] bg-[#F4F6FB] text-[#040B37] placeholder:text-[13px] placeholder:font-bold placeholder:tracking-normal placeholder:text-[#9CA3AF] focus:border-[#1C4ED1] outline-none transition-all disabled:opacity-70 font-mono"
                />
                ...
                <p className="text-[12px] font-medium text-gray-400 mt-2 text-center">
